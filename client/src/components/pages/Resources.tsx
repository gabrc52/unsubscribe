        ...
        <div className="u-hideOverflow Resources-container">
          <div className="u-flexColumn Resources-textContainer">
            ...
            <div className="u-flex u-flex-justifyCenter u-flex-alignCenter">
              <p>
                <br></br>
                Here are some resources for food insecurity at MIT. If you know of any other
                resources that should be added to this list, please let us know at{" "}
                <strong>
              ...
              <li>
                ...
                <ul className="a">
                  <li>
                    ...
                    : This interactive map showcases area grocery stores, on-campus dining
                    locations, and local favorite food spots.
                  </li>
                  <li>
