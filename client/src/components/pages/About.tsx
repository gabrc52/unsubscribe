...
import gabe from "../../public/adventure-tim.png";
import ari from "../../public/adventure-tim.png";
        ...
        <div className="u-flexColumn About-textContainer">
          ...
          <div className="u-flex">
            <div className="About-subContainer u-textCenter">
              <h4 className="About-subTitle">Gabriel Rodríguez</h4>
          ...
          <ul>
            <li>
              ...
              <ul className="a">
                <li>
                  Jay Hilton, especially, for putting up with our many questions about how to not
                  make Typescript angry at us and calling my keyboard cool B).
                </li>
              </ul>
            </li>
            <li>
